...
iyr:2011 ecl:brn hgt:59in`;
  ...
  describe("Solve Two", () => {
    describe("validationFields", () => {
      ...
      `(
        "should return $expected for $field with $value on value",
        ({ field, value, expected }) => {
          expect(validationFields[field](value)).toBe(expected);
        }
      );
    });
